...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\ursut\PycharmProjects\Role_Master\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\ursut\PycharmProjects\Role_Master\venv\Scripts\deactivate.nu'
